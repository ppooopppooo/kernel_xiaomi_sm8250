...
export CLANG_PATH=/run/media/ppooo/9a77a191-1a2f-4860-9894-0f26fb54298b/rom/Syberia/prebuilts/clang/host/linux-x86/clang-r416183b1/bin
...
echo "Set DEFCONFIG"
echo 
make CC=clang O=out vendor/lmi_defconfig
